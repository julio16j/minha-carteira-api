...
public record AtivoDTO(@NotBlank(message = "O ticker não pode estar em branco") String ticker,
		...
		@NotNull(message = "O Dividend yield não pode ser nulo") @Positive(message = "O Dividend yield deve ser positivo") Double yield,
	...
	public Ativo toEntity() {
		return new Ativo(null, ticker, quantidade, precoMedio, nota, yield, setor, tipoAtivo);
	}
}